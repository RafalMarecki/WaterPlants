...
class FertilizingAdapter (private val context : Activity, private val arrayList: ArrayList<Plant>) : ArrayAdapter<Plant>(context,
    R.layout.listitem_fertilizing, arrayList){
